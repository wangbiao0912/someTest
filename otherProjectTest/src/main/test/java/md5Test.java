...
public class md5Test {
     ...
     * @throws Exception
     */
    public md5Test() throws Exception {
        this(strDefaultKey);
    }
     ...
     * @throws Exception
     */
    public md5Test(String strKey) throws Exception {
    ...
    public void md5test1(){
        String str_temp=encryptSHA("测试");
        System.out.println(str_temp);
        System.out.println(encryptMD5(str_temp));


        try {
            String test = "123456789";
            md5Test des = new md5Test("leemenz");//自定义密钥
